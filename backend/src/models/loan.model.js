...
router.post('/getDayReport', async(request, response) => {
	...
	if(batch == 1){
		let queryString = ""
		if(role[0].usertype == 1){
			queryString = `SELECT UD.id, UD.name as employeeName, UDP.name as teamLead, UD.username as employeeID, bl.bucket, COALESCE(SUM(LD.repayment_amt), 0) as assignedAmount, COUNT(LD.repayment_amt) as assignedAmount_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 1 THEN LD.repayment_amt END), 0) as PTP_AMOUNT, COUNT(CASE WHEN lsh.statusId = 1 THEN lsh.statusId ELSE NULL END) as PTP_AMOUNT_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 2 THEN LD.repayment_amt END), 0) as RNR_AMOUNT, COUNT(CASE WHEN lsh.statusId = 2 THEN lsh.statusId ELSE NULL END) as RNR_AMOUNT_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 3 THEN LD.repayment_amt END), 0) as SWITCH_OFF, COUNT(CASE WHEN lsh.statusId = 3 THEN lsh.statusId ELSE NULL END) as SWITCH_OFF_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 4 THEN LD.repayment_amt END), 0) as PAYMENT_EXPECTED_AT, COUNT(CASE WHEN lsh.statusId = 4 THEN lsh.statusId ELSE NULL END) as PAYMENT_EXPECTED_AT_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 5 THEN LD.repayment_amt END), 0) as WAITING_FOR_CONFIRMATION, COUNT(CASE WHEN lsh.statusId = 5 THEN lsh.statusId ELSE NULL END) as WAITING_FOR_CONFIRMATION_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 6 THEN LD.repayment_amt END), 0) as collectedAmout, COUNT(CASE WHEN lsh.statusId = 6 THEN lsh.statusId ELSE NULL END) as collectedAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 7 THEN LD.repayment_amt END), 0) as NRAmout, COUNT(CASE WHEN lsh.statusId = 7 THEN lsh.statusId ELSE NULL END) as NRAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 8 THEN LD.repayment_amt END), 0) as NCAmout, COUNT(CASE WHEN lsh.statusId = 8 THEN lsh.statusId ELSE NULL END) as NCAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 9 THEN LD.repayment_amt END), 0) as INAmout, COUNT(CASE WHEN lsh.statusId = 9 THEN lsh.statusId ELSE NULL END) as INAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 10 THEN LD.repayment_amt END), 0) as RTPAmout, COUNT(CASE WHEN lsh.statusId = 10 THEN lsh.statusId ELSE NULL END) as RTPAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 11 THEN LD.repayment_amt END), 0) as CBAmout, COUNT(CASE WHEN lsh.statusId = 11 THEN lsh.statusId ELSE NULL END) as CBAmout_COUNT, COUNT(CASE WHEN lsh.statusId = 12 THEN lsh.statusId ELSE NULL END) as P3M_COUNT, COUNT(CASE WHEN lsh.statusId = 13 THEN lsh.statusId ELSE NULL END) as ALD_COUNT, COUNT(CASE WHEN lsh.statusId = 14 THEN lsh.statusId ELSE NULL END) as ATDC_COUNT, COUNT(CASE WHEN lsh.statusId = 15 THEN lsh.statusId ELSE NULL END) as EMI_COUNT,COUNT(CASE WHEN lsh.statusId = 16 THEN lsh.statusId ELSE NULL END) as PTPWIW_COUNT, COUNT(CASE WHEN lsh.statusId = 17 THEN lsh.statusId ELSE NULL END) as PP_COUNT, COUNT(CASE WHEN lsh.statusId = 18 THEN lsh.statusId ELSE NULL END) as RBI_COUNT, COUNT(CASE WHEN lsh.statusId = 20 THEN lsh.statusId ELSE NULL END) as CASH_COUNT, (COUNT(CASE WHEN lsh.statusId = 1 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 2 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 3 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 4 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 7 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 8 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 9 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 10 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 11 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 12 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 13 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 14 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 15 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 16 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 17 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 18 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 20 THEN lsh.statusId ELSE NULL END)) as callCount, COALESCE(COALESCE(SUM(LD.repayment_amt), 0) - COALESCE(SUM(CASE WHEN lsh.statusId = 5 THEN LD.repayment_amt END), 0)) as remainingAmount, (COUNT(LD.repayment_amt) - COUNT(CASE WHEN lsh.statusId = 6 THEN lsh.statusId ELSE NULL END)) as remainingAmount_COUNT, COALESCE(COALESCE(COUNT(LD.repayment_amt)) - COALESCE((COUNT(CASE WHEN lsh.statusId = 1 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 2 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 3 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 4 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 7 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 8 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 9 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 10 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 11 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 12 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 13 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 14 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 15 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 16 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 17 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 18 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 20 THEN lsh.statusId ELSE NULL END)))) as remainingCalls, COALESCE(((COALESCE(SUM(CASE WHEN lsh.statusId = 6 THEN LD.repayment_amt END), 0) / COALESCE(SUM(LD.repayment_amt), 0)) * 100), 0) as inPercentage FROM userdetails UD JOIN userdetails UDP ON UDP.id = UD.parentId JOIN bucket_list bl ON bl.id = UD.bucket_id LEFT JOIN loan_details LD ON UD.id = LD.assigned_emp_id AND LD.batch_status = 1 LEFT JOIN (SELECT comments as loan_comments, loanId, statusId FROM loans_status_history WHERE active = 1 AND dateTime LIKE '%${fromDate}%' GROUP BY loanId) AS lsh ON LD.loanid = lsh.loanId WHERE UD.usertype = 0 AND UD.active = 1 GROUP BY UD.id`
		}
		if(role[0].usertype == 2){
		...
		let queryString = ""
		if(role[0].usertype == 1){
			queryString = `SELECT UD.id, UD.name as employeeName, UD.username as employeeID, bl.bucket, COALESCE(SUM(LD.repayment_amt), 0) as assignedAmount, COUNT(LD.repayment_amt) as assignedAmount_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 1 THEN LD.repayment_amt END), 0) as PTP_AMOUNT, COUNT(CASE WHEN lsh.statusId = 1 THEN lsh.statusId ELSE NULL END) as PTP_AMOUNT_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 2 THEN LD.repayment_amt END), 0) as RNR_AMOUNT, COUNT(CASE WHEN lsh.statusId = 2 THEN lsh.statusId ELSE NULL END) as RNR_AMOUNT_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 3 THEN LD.repayment_amt END), 0) as SWITCH_OFF, COUNT(CASE WHEN lsh.statusId = 3 THEN lsh.statusId ELSE NULL END) as SWITCH_OFF_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 4 THEN LD.repayment_amt END), 0) as PAYMENT_EXPECTED_AT, COUNT(CASE WHEN lsh.statusId = 4 THEN lsh.statusId ELSE NULL END) as PAYMENT_EXPECTED_AT_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 5 THEN LD.repayment_amt END), 0) as WAITING_FOR_CONFIRMATION, COUNT(CASE WHEN lsh.statusId = 5 THEN lsh.statusId ELSE NULL END) as WAITING_FOR_CONFIRMATION_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 6 THEN LD.repayment_amt END), 0) as collectedAmout, COUNT(CASE WHEN lsh.statusId = 6 THEN lsh.statusId ELSE NULL END) as collectedAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 7 THEN LD.repayment_amt END), 0) as NRAmout, COUNT(CASE WHEN lsh.statusId = 7 THEN lsh.statusId ELSE NULL END) as NRAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 8 THEN LD.repayment_amt END), 0) as NCAmout, COUNT(CASE WHEN lsh.statusId = 8 THEN lsh.statusId ELSE NULL END) as NCAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 9 THEN LD.repayment_amt END), 0) as INAmout, COUNT(CASE WHEN lsh.statusId = 9 THEN lsh.statusId ELSE NULL END) as INAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 10 THEN LD.repayment_amt END), 0) as RTPAmout, COUNT(CASE WHEN lsh.statusId = 10 THEN lsh.statusId ELSE NULL END) as RTPAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 11 THEN LD.repayment_amt END), 0) as CBAmout, COUNT(CASE WHEN lsh.statusId = 11 THEN lsh.statusId ELSE NULL END) as CBAmout_COUNT, (COUNT(CASE WHEN lsh.statusId = 1 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 2 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 3 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 4 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 7 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 8 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 9 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 10 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 11 THEN lsh.statusId ELSE NULL END)) as callCount, COALESCE(COALESCE(SUM(LD.repayment_amt), 0) - COALESCE(SUM(CASE WHEN lsh.statusId = 5 THEN LD.repayment_amt END), 0)) as remainingAmount, (COUNT(LD.repayment_amt) - COUNT(CASE WHEN lsh.statusId = 6 THEN lsh.statusId ELSE NULL END)) as remainingAmount_COUNT, COALESCE(((COALESCE(SUM(CASE WHEN lsh.statusId = 6 THEN LD.repayment_amt END), 0) / COALESCE(SUM(LD.repayment_amt), 0)) * 100), 0) as inPercentage FROM userdetails UD JOIN bucket_list bl ON bl.id = UD.bucket_id LEFT JOIN loan_details LD ON UD.id = LD.assigned_emp_id LEFT JOIN (SELECT comments as loan_comments, loanId, statusId FROM loans_status_history WHERE active = 1 AND dateTime between '${fromDate} 00:00:00' and '${toDate} 23:59:00' GROUP BY loanId) AS lsh ON LD.loanid = lsh.loanId WHERE UD.usertype = 0 AND UD.active = 1 GROUP BY UD.id`
		}
		if(role[0].usertype == 2){
			queryString = `SELECT UD.id, UD.name as employeeName, UD.username as employeeID, bl.bucket, COALESCE(SUM(LD.repayment_amt), 0) as assignedAmount, COUNT(LD.repayment_amt) as assignedAmount_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 1 THEN LD.repayment_amt END), 0) as PTP_AMOUNT, COUNT(CASE WHEN lsh.statusId = 1 THEN lsh.statusId ELSE NULL END) as PTP_AMOUNT_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 2 THEN LD.repayment_amt END), 0) as RNR_AMOUNT, COUNT(CASE WHEN lsh.statusId = 2 THEN lsh.statusId ELSE NULL END) as RNR_AMOUNT_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 3 THEN LD.repayment_amt END), 0) as SWITCH_OFF, COUNT(CASE WHEN lsh.statusId = 3 THEN lsh.statusId ELSE NULL END) as SWITCH_OFF_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 4 THEN LD.repayment_amt END), 0) as PAYMENT_EXPECTED_AT, COUNT(CASE WHEN lsh.statusId = 4 THEN lsh.statusId ELSE NULL END) as PAYMENT_EXPECTED_AT_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 5 THEN LD.repayment_amt END), 0) as WAITING_FOR_CONFIRMATION, COUNT(CASE WHEN lsh.statusId = 5 THEN lsh.statusId ELSE NULL END) as WAITING_FOR_CONFIRMATION_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 6 THEN LD.repayment_amt END), 0) as collectedAmout, COUNT(CASE WHEN lsh.statusId = 6 THEN lsh.statusId ELSE NULL END) as collectedAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 7 THEN LD.repayment_amt END), 0) as NRAmout, COUNT(CASE WHEN lsh.statusId = 7 THEN lsh.statusId ELSE NULL END) as NRAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 8 THEN LD.repayment_amt END), 0) as NCAmout, COUNT(CASE WHEN lsh.statusId = 8 THEN lsh.statusId ELSE NULL END) as NCAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 9 THEN LD.repayment_amt END), 0) as INAmout, COUNT(CASE WHEN lsh.statusId = 9 THEN lsh.statusId ELSE NULL END) as INAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 10 THEN LD.repayment_amt END), 0) as RTPAmout, COUNT(CASE WHEN lsh.statusId = 10 THEN lsh.statusId ELSE NULL END) as RTPAmout_COUNT, COALESCE(SUM(CASE WHEN lsh.statusId = 11 THEN LD.repayment_amt END), 0) as CBAmout, COUNT(CASE WHEN lsh.statusId = 11 THEN lsh.statusId ELSE NULL END) as CBAmout_COUNT, (COUNT(CASE WHEN lsh.statusId = 1 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 2 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 3 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 4 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 7 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 8 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 9 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 10 THEN lsh.statusId ELSE NULL END) + COUNT(CASE WHEN lsh.statusId = 11 THEN lsh.statusId ELSE NULL END)) as callCount, COALESCE(COALESCE(SUM(LD.repayment_amt), 0) - COALESCE(SUM(CASE WHEN lsh.statusId = 5 THEN LD.repayment_amt END), 0)) as remainingAmount, (COUNT(LD.repayment_amt) - COUNT(CASE WHEN lsh.statusId = 6 THEN lsh.statusId ELSE NULL END)) as remainingAmount_COUNT, COALESCE(((COALESCE(SUM(CASE WHEN lsh.statusId = 6 THEN LD.repayment_amt END), 0) / COALESCE(SUM(LD.repayment_amt), 0)) * 100), 0) as inPercentage FROM userdetails UD JOIN bucket_list bl ON bl.id = UD.bucket_id LEFT JOIN loan_details LD ON UD.id = LD.assigned_emp_id LEFT JOIN (SELECT comments as loan_comments, loanId, statusId FROM loans_status_history WHERE active = 1 AND dateTime between '${fromDate} 00:00:00' and '${toDate} 23:59:00' GROUP BY loanId) AS lsh ON LD.loanid = lsh.loanId WHERE UD.usertype = 0 AND UD.active = 1 AND UD.parentId = ${role[0].id} GROUP BY UD.id`
		}
