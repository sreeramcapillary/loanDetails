...
router.post('/getLoanListByEmpByDate', function (request, response) {
	...
	connection.query(`SELECT ld.*, LS.status_type as status, lsh.loan_comments, lsh.statusId 
