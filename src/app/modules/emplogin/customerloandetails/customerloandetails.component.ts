  ...
  onSelect({ selected }) {
   if(selected[0].statusId!=6){
    ...
    .subscribe(
      ...
      this.whatsappMsgCustomer = "phone=91"+ selected[0].mobile +"&text=Dear *LOANFRONT CUSTOMER*%0a%0aNAME : *"+ selected[0].customer_Name +"*%0aREFERENCE 1 : *"+ selected[0].ref_name1 +"* (*"+ selected[0].ref_mobile_num1 +"*)%0aREFERENCE 2 : *"+ selected[0].ref_name2 +"* (*"+ selected[0].ref_mobile_num2 +"*)%0aDUE AMOUNT : *"+ selected[0].repayment_amt +"*%0aADDRESS : *"+ selected[0].current_address +"*%0a%0aOur Collection Recovery Team is not able to figure out the actual reason for Non-Payment of your Loan Amount of LoanFront, Due to which your CIBIL record is getting Impacted and You are being charged penalty daily on your principal Amount. We are legally mandated by RBI to report all financial behaviour of our customer to credit bureaus(CIBIL/CRIF-ETC) agencies every month please repay your overdue loan,  Kindly Pay Now Or Click For Details https://www.loanfront.in/pay/index.php. For more Details Contact on Same Number.%0a%0aHello *"+ selected[0].customer_Name +"*,%0aToday our team tries to contact you, but your phone is not reachable. We tried to help you out with different flexible payment options also, but you are not responding to our calls. But now we have no choice but to initiate the legal procedure if you are not paying your amount by today and the ‘Suit filed’ status will be updated to your CIBIL which will create a problem to get any loan in future from any other Bank(s). Request you to get in touch with our agent and discuss the payment plan to resolve the matter.%0a%0a*Alert* : We are unable to help u to remove penalty charges, also if you are unreachable, this message will be shared with your reference contacts given in Loan Application till repayment.%0a%0aTHANK YOU : *LOANFRONT*"
