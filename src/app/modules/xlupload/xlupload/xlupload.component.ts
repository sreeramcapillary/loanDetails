                ...
                for (var bucketKey in this.loanDetails['bucket']) {
                  for (var languageKey in this.loanDetails['bucket'][bucketKey]["langauage"]) {
                    ...
                    if (employeeCount > 0) {
                      ...
                      console.log("averageLoanValue for bucket "+bucketKey+" => Language "+languageKey+" : "+averageLoanValue+", totalLoanDataValue : "+parseInt(this.loanDetails['bucket'][bucketKey]["langauage"][languageKey]["totalLoanDataValue"], 10))
